...
| 数据源             | 说明                                                       | 相关文档 / 脚本                                                                                |
| ------------------ | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| **xysz**           | 星河数智 / AmazingData，A 股行情、财务、股东、行业等       | [docs/星河数智Parquet数据导入指南.md](星河数智Parquet数据导入指南.md)、`scripts/import_xysz_parquet_to_zvt.py` |
| **qmt**            | 迅投 QMT（Windows），通过 RPC 在 Linux 拉行情与财务        | [docs/QMT_Linux集成手册.md](QMT_Linux集成手册.md)、`scripts/update_qmt_data.py`        |
...
- Parquet → ZVT 导入说明：[docs/星河数智Parquet数据导入指南.md](星河数智Parquet数据导入指南.md)
...
- Linux 侧接入说明、RPC 架构、常见问题：[docs/QMT_Linux集成手册.md](QMT_Linux集成手册.md)
- QMT 转发服务（Windows ↔ Ubuntu）：[docs/QMT转发服务指南.md](QMT转发服务指南.md)
